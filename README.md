...
-   Compiling the program: 'gcc -Wall -Werror -Wextra -pedantic -std=c89 *.c -o monty'
...
-   All the prototypes of all your functions should be included in your header file called monty.h
-   Don’t forget to push your header file
-   YAll your header files should be include guarded
...
## AUTHORS
-   Alfred Njeru Chomba Chomba- njeruchomba2@gmail.com
-   SHARON WARUKIRA - shrnkira@gmail.com
